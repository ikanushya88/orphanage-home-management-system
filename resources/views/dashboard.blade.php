<x-app-layout>
    ...
    <section class="header relative pt-16 items-center flex h-screen max-h-860-px">
        ...
        <img class="absolute top-0 b-auto right-0 pt-16 sm:w-6/12 -mt-48 sm:mt-0 w-10/12 max-h-860-px" src="/img/banner.jpg"
            alt="...">
    </section>
        ...
        <div class="container mx-auto">
            <div class="flex flex-wrap items-center">
                ...
                <div class="w-full md:w-6/12 px-4">
                    <p class="text-xl">
                        Kids don't choose to be an orphan. They don't decide to lose their loved one to illness, violence,
            ...
            <div class="flex flex-wrap justify-center bg-white shadow-xl rounded-lg -mt-64 py-16 px-12 relative z-10">
                <div class="w-full text-center lg:w-8/12">
                    ...
                    <p class="text-blueGray-500 text-lg leading-relaxed mt-4 mb-4">
                        We occassionally send you our events related to helping hands together with poor children. Subscribe
