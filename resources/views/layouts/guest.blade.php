...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="text-blueGray-700">
                ...
                <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
                    <div class="pt-32 sm:pt-0">
                        <h2 class="font-semibold text-4xl text-blueGray-600">
                            Dedicated service to the needy Children &amp; Elders
                        </h2>
        ...
        <section class="mt-48 md:mt-40 pb-40 relative bg-blueGray-100">
                ...
                <div class="flex flex-wrap items-center">
                    <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-32">
                        <div
                            ...
                            <img alt="..."
                                src="https://bmkltsly13vb.compat.objectstorage.ap-mumbai-1.oraclecloud.com/cdn.dailymirror.lk/media/images/image_1536157499-ba25c670a5.jpg"
                    ...
                    <div class="w-full md:w-6/12 px-4">
                        <p class="text-xl">
                            Kids don't choose to be an orphan. They don't decide to lose their loved one to illness, violence, relocation &amp; disaster. They don;t decided to endure the side effects of such a significant misforture, In any case you can decide to give them trust.
                        </p>
            ...
            <div class="container mx-auto overflow-hidden pb-20 hidden">
                <div class="flex flex-wrap items-center">
            ...
            <div class="container mx-auto px-4 pb-32 pt-48 hidden">
            ...
            <div class="justify-center text-center flex flex-wrap mt-24 hidden">
                ...
                <div class="flex flex-wrap justify-center bg-white shadow-xl rounded-lg -mt-64 py-16 px-12 relative z-10">
                    <div class="w-full text-center lg:w-8/12">
                        ...
                        <p class="text-blueGray-500 text-lg leading-relaxed mt-4 mb-4">
                            We occassionally send you our events related to helping hands together with poor children. Subscribe us to get all activities without missing.
                        </p>
                ...
                <div class="flex flex-wrap items-center md:justify-between justify-center">
                    <div class="w-full md:w-4/12 px-4 mx-auto text-center">
                        <div class="text-sm text-blueGray-500 font-semibold py-1">
                            Copyright © <span id="get-current-year">2022</span> Notus JS by
