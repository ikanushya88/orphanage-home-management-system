    ...
    <div class="header_wrap">
        <div class="header_inner mcontainer">
            <div class="left_side">
                ...
                <div id="logo">
                    <a href="feed.html">
                        ...
                        <img src="/logo.png" class="logo_mobile" alt=""> --}}
                    </a>
                </div>
            </div>
            ...
            <div class="header_search"><i class="uil-search-alt"></i>
                <input value="" type="text" class="form-control" placeholder="Search for Homes..."
                    autocomplete="off">
                <div uk-drop="mode: click" class="header_search_dropdown">
                    ...
                    <ul>
                        <li>
                            <a href="#">
                                <img src="/template/images/avatars/avatar-1.jpg" alt="" class="list-avatar">
                                <div class="list-name"> Erica Jones </div>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="/template/images/avatars/avatar-2.jpg" alt="" class="list-avatar">
                                <div class="list-name"> Coffee Addicts </div>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="/template/images/avatars/avatar-3.jpg" alt="" class="list-avatar">
                                <div class="list-name"> Mountain Riders </div>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="/template/images/avatars/avatar-4.jpg" alt="" class="list-avatar">
                                <div class="list-name"> Property Rent And Sale </div>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="/template/images/avatars/avatar-5.jpg" alt="" class="list-avatar">
                                <div class="list-name"> Erica Jones </div>
                            </a>
                        </li>
                    </ul>
                ...
                <div class="header_widgets">
                    ...
                    <div uk-drop="mode: click" class="header_dropdown dropdown_cart">
                        ...
                        <ul class="dropdown_cart_scrollbar" data-simplebar>
                            ...
                            <li>
                                <div class="cart_avatar">
                                    <img src="/template/images/product/13.jpg" alt="">
                                </div>
                                <div class="cart_text">
                                    <div class=" font-semibold leading-4 mb-1.5 text-base line-clamp-1">
                                        Parfum Spray</div>
                            ...
                            <li>
                                <div class="cart_avatar">
                                    <img src="/template/images/product/15.jpg" alt="">
                                </div>
                                <div class="cart_text">
                                    <div class=" font-semibold leading-4 mb-1.5 text-base line-clamp-1">
                                        Herbal Shampoo </div>
                            ...
                            <li>
                                <div class="cart_avatar">
                                    <img src="/template/images/product/14.jpg" alt="">
                                </div>
                                <div class="cart_text">
                                    <div class=" font-semibold leading-4 mb-1.5 text-base line-clamp-1">
                                        Wood Chair </div>
                            ...
                            <li>
                                <div class="cart_avatar">
                                    <img src="/template/images/product/9.jpg" alt="">
                                </div>
                                <div class="cart_text">
                                    <div class=" font-semibold leading-4 mb-1.5 text-base line-clamp-1">
                    ...
                    <div uk-drop="mode: click" class="header_dropdown">
                        <div class="dropdown_scrollbar" data-simplebar>
                            ...
                            <ul>
                                ...
                                <li class="not-read">
                                    <a href="#">
                                        <div class="drop_avatar status-online"> <img
                                                src="/template/images/avatars/avatar-2.jpg" alt="">
                                        </div>
                                        <div class="drop_text">
                                            <p>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="drop_avatar"> <img src="/template/images/avatars/avatar-3.jpg"
                                                alt="">
                                        </div>
                                        <span class="drop_icon bg-gradient-primary">
                                            <i class="icon-feather-thumbs-up"></i>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="drop_avatar"> <img src="/template/images/avatars/avatar-1.jpg"
                                                alt="">
                                        </div>
                                        <div class="drop_text">
                                            <p>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="drop_avatar"> <img src="/template/images/avatars/avatar-2.jpg"
                                                alt="">
                                        </div>
                                        <div class="drop_text">
                                            <p>
                    ...
                    <div uk-drop="mode: click" class="header_dropdown is_message">
                        <div class="dropdown_scrollbar" data-simplebar>
                            ...
                            <ul>
                                <li class="un-read">
                                    <a href="#">
                                        <div class="drop_avatar"> <img src="/template/images/avatars/avatar-7.jpg"
                                                alt="">
                                        </div>
                                        <div class="drop_text">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="drop_avatar"> <img src="/template/images/avatars/avatar-6.jpg"
                                                alt="">
                                        </div>
                                        <div class="drop_text">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="drop_avatar"> <img src="/template/images/avatars/avatar-5.jpg"
                                                alt="">
                                        </div>
                                        <div class="drop_text">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="drop_avatar"> <img src="/template/images/avatars/avatar-4.jpg"
                                                alt="">
                                        </div>
                                        <div class="drop_text">
                                            <strong> Jonathan Madano </strong> <time> Sun</time>
                    ...
                    <a href="#">
                        <img src="/template/images/avatars/avatar-2.jpg" class="is_avatar" alt="">
                    </a>
