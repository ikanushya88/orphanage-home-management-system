    ...
    <div class="mcontainer">
        ...
        <div class="lg:flex">
            <div class="lg:w-3/4 lg:px-20 space-y-7">
                ...
                <livewire:feeder-block :home="'all'" :onlyFundraise="'0'" />
            ...
            <div class="lg:w-72 w-full">
                ...
                <a href="#birthdays" uk-toggle>
                    <div class="bg-white mb-5 px-4 py-3 rounded-md shadow">
                        <h3 class="text-line-through font-semibold mb-1"> Welcome! </h3>
                        <div class="-mx-2 duration-300 flex hover:bg-gray-50 px-2 py-2 rounded-md">
                            <p class=" leading-6">
                                1000's of students and child care homes are in need of fund to acheive their basic needs. Thanks for your support towards us ❤️.
                            </p>
                        </div>
                    </div>
                </a>

                <h3 class="text-xl font-semibold"> <small>ADVERTISEMENTS</small> </h3>

                <div class="" uk-sticky="offset:80">

                    <img src="https://i.pinimg.com/736x/96/85/1d/96851db7a327348df46da306da52899c.jpg" alt="" class="w-full" />
