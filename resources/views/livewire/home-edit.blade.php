<div>
    ...
    <div class="max-w-2xl m-auto shadow-md rounded-md bg-white lg:mt-20">
        ...
        <div class="text-center border-b border-gray-100 py-6">
            <h3 class="font-bold text-xl"> Create {{App\Models\Home::find($home)->name}} </h3>
        </div>
        ...
        <div class="p-10 space-y-7">
            ...
            <div class="line">
                <input class="line__input" id="name" name="name" wire:model='name' type="text" value=""
                ...
                <div class="flex bg-gray-50 border border-purple-100 rounded-2xl p-2 shadow-sm items-center">
                    ...
                    <div class="flex flex-1 items-center lg:justify-end justify-center space-x-2">
                        <div>
                            ...
                            @else
                            <img src="{{ \Storage::url($edit_logo) }}" class="h-9" />
                            @endif
                        </div>
                ...
                <div class="flex bg-gray-50 border border-purple-100 rounded-2xl p-2 shadow-sm items-center">
                    ...
                    <div class="flex flex-1 items-center lg:justify-end justify-center space-x-2">
                        <div>
                            ...
                            @else
                            <img src="{{ \Storage::url($edit_cover_image) }}" class="h-9" />
                            @endif
                        </div>
            ...
            <div class="w-full md:inline-flex gap-3">
                <div class="w-full md:w-1/3 mt-3 md:mt-0">
                    <div class="line">
                        <input class="line__input" id="contact_number" name="contact_number" wire:model='contact_number'
                            type="text" value="" autocomplete="off" placeholder=" Contact Number">
                ...
                <div class="w-full md:w-2/3 mt-3 md:mt-0">
                    <div class="line">
                        <input class="line__input" id="email" name="email" wire:model='email' type="email" value=""
            ...
            <div class="line">
                <input class="line__input" id="address" name="address" wire:model='address' type="text" value=""
            ...
            <div class="line h-32">
                <textarea class="line__input h-32" id="" name="about" wire:model='about' type="text" value=""
                    autocomplete="off" placeholder="Home description"></textarea>
        ...
        <div class="border-t flex justify-between lg:space-x-10 p-7 bg-gray-50 rounded-b-md">
            <p class="text-sm leading-6 text-green-700 font-bold">Uploading new document will cause your home UNVERIFIED STATUS till admin approvals.</p>
